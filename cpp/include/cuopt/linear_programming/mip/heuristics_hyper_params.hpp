...
struct mip_heuristics_hyper_params_t {
  ...
  i_t presolve_max_rounds = 30;                   // Papilo presolve rounds cap (deterministic
                                                  // iteration limit; <=0 keeps Papilo's default)
  f_t cuopt_presolve_work_limit = 30.0;           // cuOpt presolve (probing cache) work-unit budget
